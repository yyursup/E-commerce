    ...
    <div className="relative w-full" ref={containerRef}>
      ...
      <div
        className={cn(
          ...
          isDark
            ? 'border-slate-700 bg-slate-800 text-white focus-within:border-amber-500 focus-within:ring-2 focus-within:ring-amber-500/20'
            : 'border-stone-200 bg-stone-50 text-stone-900 focus-within:border-amber-500 focus-within:ring-2 focus-within:ring-amber-500/20',
      ...
      >
        ...
        <input
          ...
          className={cn(
            'w-full py-2.5 pr-10 text-xs outline-none bg-transparent placeholder:text-stone-400 dark:placeholder:text-slate-500',
